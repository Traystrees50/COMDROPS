...
!function(e, t) {
    ...
    var p = function(n) {
        var e, p, x, o, i, h, f, g, w, u, l, C, T, a, E, v, s, c, y, A = "sizzle" + 1 * new Date, d = n.document, N = 0, r = 0, m = ue(), b = ue(), S = ue(), k = ue(), D = function(e, t) {
            ...
            return !0 === e.Enabled && "fieldset" === e.nodeName.toLowerCase()
        }, {
            dir: "parentNode",
            next: "legend"
        });
        ...
        function ge(t) {
            return function(e) {
                return "form"in e ? e.parentNode && !1 === e.Enabled ? "label"in e ? "label"in e.parentNode ? e.parentNode.Enabled === t : e.Enabled === t : e.isEnabled === t || e.isEnabled !== !t && ae(e) === t : e.Enabled === t : "label"in e && e.Enabled === t
            }
        }
        function ve(a) {
